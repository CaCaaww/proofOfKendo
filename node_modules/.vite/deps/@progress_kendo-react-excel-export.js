...
GenericWorker.prototype.error = function error(e7) {
  if (this.isFinished) {
    return false;
  }
  if (this.isPaused) {
    this.generatedError = e7;
  } else {
    this.isFinished = true;
    this.emit("error", e7);
    if (this.previous) {
      this.previous.error(e7);
    }
    this.cleanUp();
  }
  return true;
...
var ZipFileWorker = function(GenericWorker3) {
  ...
  ZipFileWorker2.prototype.error = function error2(e7) {
    var sources = this._sources;
    if (!GenericWorker3.prototype.error.call(this, e7)) {
      return false;
    }
...
DataReader.prototype.skip = function skip(n2) {
...
function dateToJulianDays(y, m, d3) {
  return (1461 * (y + 4800 + ((m - 13) / 12 | 0)) / 4 | 0) + (367 * (m - 1 - 12 * ((m - 13) / 12 | 0)) / 12 | 0) - (3 * ((y + 4900 + ((m - 13) / 12 | 0)) / 100 | 0) / 4 | 0) + d3 - 32075;
}
...
var d = (t2, e7, r3) => (l2) => {
  r3(e7, l2);
  const s2 = n.renderToStaticMarkup(g.createElement(t2, { ...e7 })), o4 = Number(s2);
  return isNaN(o4) ? s2 : o4;
};
var f = (t2, e7) => {
  t2.$implicit = t2.group = e7, t2.field = e7.field, t2.value = e7.value, t2.aggregates = e7.aggregates;
};
var u = (t2, e7) => {
  t2.group = e7.group, t2.$implicit = t2.aggregates = e7;
};
var C = (t2, e7) => {
};
var F = (t2) => {
  ...
  const p3 = (l2, s2, o4) => {
    l2.forEach((i) => {
      if (i.level === o4) {
        const a3 = new O(i, r3);
        if (s2.push(a3), i.children && i.children.length > 1) {
          const h3 = a3.columns = [];
          p3(i.children, h3, o4 + 1);
        } else
          r3++;
      }
    });
  };
  return p3(t2, e7, 0), e7;
};
var O = class {
  constructor(e7, r3) {
    this.columns = null, this.title = e7.title, this.field = e7.field, this.hidden = e7.hidden, this.locked = e7.locked, this.width = e7.width, this.headerCellOptions = e7.headerCellOptions, this.cellOptions = e7.cellOptions, this.groupHeaderCellOptions = e7.groupHeaderCellOptions, this.groupFooterCellOptions = e7.groupFooterCellOptions, this.footerCellOptions = e7.footerCellOptions, e7.footer && (this.footerTemplate = d(
      e7.footer,
      {
        $implicit: e7,
        column: e7,
      ...
      C
    )), e7.groupFooter && (this.groupFooterTemplate = d(
      e7.groupFooter,
      {
        column: e7,
        field: e7.field
      ...
      u
    )), e7.groupHeader && (this.groupHeaderTemplate = d(e7.groupHeader, {}, f));
  }
};

// node_modules/@progress/kendo-react-excel-export/ooxml/workbook.mjs
var d2 = (e7) => Math.max(...e7.map((r3) => r3.level)) + 1;
var p = (e7) => {
  const r3 = F(e7.columns), t2 = new excel_exporter_default({
    columns: r3,
    data: e7.data,
    filterable: e7.filterable,
    groups: e7.group,
    paddingCellOptions: e7.paddingCellOptions,
    headerPaddingCellOptions: e7.headerPaddingCellOptions,
    hierarchy: e7.hierarchy ? { depth: d2(e7.data), itemLevel: (l2) => l2.level } : null,
    collapsible: e7.collapsible
  }).workbook();
  return t2.creator = e7.creator, t2.date = e7.date, t2.rtl = e7.dir === "rtl", t2;
};
var b = (e7) => new Workbook(e7).toDataURL();
var h2 = (e7) => e7 && e7.sheets;
...
var e = {
  ...
  publishDate: 1745411247,
  version: "10.2.0",
  licensingDocsUrl: "https://www.telerik.com/kendo-react-ui/components/my-license/"
};

// node_modules/@progress/kendo-react-excel-export/ExcelExport.mjs
var a = class a2 extends e2.Component {
  constructor(o4) {
    ...
    }, this.extractColumns = (t2, r3 = 0) => Array.isArray(t2) ? t2.map((i) => this.extractChild(i, r3)) : [t2, this.extractChild(t2, r3)], this.extractChild = (t2, r3 = 0) => e2.isValidElement(t2) ? {
      ...t2.props,
      width: t2.props.width && parseInt(`${t2.props.width}`, 10),
      level: r3,
      children: t2.props.children && this.extractColumns(t2.props.children, r3 + 1)
    } : {
      ...t2,
      level: r3,
      children: t2.children && this.extractColumns(t2.children, r3 + 1)
    }, this.getExportData = (t2) => {
      let r3;
      return t2 ? Array.isArray(t2) ? r3 = {
        data: t2
      } : r3 = t2 : r3 = {
        data: this.props.data,
        group: this.props.group
      }, r3;
    }, this.showLicenseWatermark = !h(e, { component: "ExcelExport" }), this.save = this.save.bind(this), this.toDataURL = this.toDataURL.bind(this), this.workbookOptions = this.workbookOptions.bind(this);
  }
  /**
   ...
   */
  save(o4, t2) {
    this.toDataURL(o4, t2).then((...r3) => {
      this.props.onExportComplete && this.props.onExportComplete.call(void 0, { target: this }), this.saveFile(...r3);
    });
  }
  /**
   ...
   */
  toDataURL(o4, t2) {
    const r3 = h2(o4) ? o4 : this.workbookOptions(o4, t2);
    return b(r3);
  }
  /**
  ...
  workbookOptions(o4, t2) {
    const r3 = this.getExportData(o4), i = this.props.children, n2 = i && i.type && i.type.displayName === "KendoReactGrid" && i.props && e2.Children.toArray(i.props.children), l2 = this.extractColumns(
      n2 || t2 || this.props.columns || e2.Children.toArray(i)
    );
    return p({
      columns: l2,
      data: r3.data,
   ...
   */
  render() {
    return e2.createElement(e2.Fragment, null, this.props.children || null, this.showLicenseWatermark && e2.createElement(l, null));
  }
};
a.propTypes = {
...
export {
  ...
  r2 as ExcelExportGroupHeader,
  main_exports as KendoOoxml,
  h2 as isWorkbookOptions,
  b as toDataURL,
