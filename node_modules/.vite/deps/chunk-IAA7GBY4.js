...
function getIndexByName(names, state, lower) {
  var i4 = 0, length = names.length, name, nameLength, matchLength = 0, matchIdx = 0, subValue;
  for (; i4 < length; i4++) {
    name = names[i4];
...
var o = class {
   ...
   */
  format(r3, ...t6) {
    return t6.length === 1 && Array.isArray(t6[0]) ? format(r3, t6[0], this.locale) : format(r3, t6, this.locale);
  }
  /**
   ...
   */
  formatDate(r3, t6) {
    return formatDate(r3, t6, this.locale);
  }
  /**
   ...
   */
  toString(r3, t6) {
    return toString(r3, t6, this.locale);
  }
  /**
   ...
   */
  parseNumber(r3, t6) {
    return parseNumber(r3, this.locale, t6);
  }
  /**
   ...
   */
  parseDate(r3, t6) {
    return parseDate(r3, t6, this.locale);
  }
  /**
   ...
   */
  formatNumber(r3, t6) {
    return formatNumber(r3, t6, this.locale);
  }
  /**
...
var s2 = class {
  ...
  toLanguageString(t6, e4) {
    return this.language && e[this.language] && e[this.language].hasOwnProperty(t6) ? e[this.language][t6] : e4;
  }
};

// node_modules/@progress/kendo-react-intl/globalization/GlobalizationContext.mjs
var o2 = __toESM(require_react(), 1);
var r = o2.createContext({
  intl: new o("en"),
  localization: new s2()
});
...
function l(t6) {
  ...
  const o8 = t6.context;
  return o8 && o8.intl ? o8.intl : new o("en");
}
function s3(t6) {
  if (!t6 && true)
    throw `Passed component - ${t6} is invalid.`;
  const o8 = t6.context;
  return o8 && o8.localization ? o8.localization : new s2();
}
function p(t6) {
  t6.contextType = r;
}
...
var t = class t2 extends e2.Component {
  /**
   ...
   */
  getIntlService() {
    return new o(this.props.locale);
  }
  /**
   * @hidden
   */
  render() {
    return e2.createElement(r.Consumer, null, (n4) => e2.createElement(r.Provider, { value: { ...n4, intl: this.getIntlService() } }, this.props.children));
  }
};
t.propTypes = {
...
var l2 = (...i4) => {
  i4.forEach((e4) => {
    const n4 = Object.keys(e4)[0];
    if (["main", "supplemental"].includes(n4)) {
      const s4 = Object.keys(e4[n4])[0];
      s4 in o4 ? o4[s4].includes(e4) || (o4[s4] = [...o4[s4], e4]) : o4[s4] = [e4];
    }
  }), load(...i4);
};
...
var n = (o8) => {
  const { locale: r3, data: t6, children: a2 } = o8;
  return r3 && l2(t6), a2;
};
...
var t3 = class t4 extends e3.Component {
  /**
   * Returns a localization service. The method is suitable for overriding when you implement custom localization behavior.
   */
  getLocalizationService() {
    return new s2(this.props.language);
  }
  /**
   * @hidden
   */
  render() {
    return e3.createElement(r.Consumer, null, (i4) => e3.createElement(r.Provider, { value: { ...i4, localization: this.getLocalizationService() } }, this.props.children));
  }
};
t3.propTypes = {
...
var p2 = /* @__PURE__ */ Object.create({});
var r2 = (s4, o8, t6) => {
  for (const e4 in s4)
    if (s4.hasOwnProperty(e4)) {
      const n4 = [...t6];
      if (n4.push(e4), typeof s4[e4] != "string")
        r2(s4[e4], o8, n4);
      else {
        const f = s4[e4];
        Object.defineProperty(o8, n4.join("."), { value: f, enumerable: true });
      }
    }
};
function a(s4, o8) {
...
var n3 = (o8) => {
  const { data: r3, language: a2, children: t6 } = o8;
  return a2 && a(r3, a2), t6;
};

// node_modules/@progress/kendo-react-intl/server/ServerGlobalization.mjs
var G = (l3) => {
  var r3, a2, n4;
  const { language: t6 = "", locale: e4 = "en", children: c } = l3, s4 = localeInfo(e4), f = (r3 = e[t6]) != null ? r3 : [], p3 = ((a2 = o4.version) != null ? a2 : []).concat((n4 = o4[s4.name]) != null ? n4 : []), [d] = s(e4 ? o3 : import_react.default.Fragment), [v2] = s(t6 ? o5 : import_react.default.Fragment);
  return import_react.default.createElement(n3, { data: f, language: t6 }, import_react.default.createElement(n, { data: p3, locale: e4 }, import_react.default.createElement(v2, { language: t6 }, import_react.default.createElement(d, { locale: e4 }, c))));
};

// node_modules/@progress/kendo-react-intl/hooks/useInternationalization.mjs
var t5 = __toESM(require_react(), 1);
var i2 = () => t5.useContext(r).intl;

// node_modules/@progress/kendo-react-intl/hooks/useLocalization.mjs
var o7 = __toESM(require_react(), 1);
var i3 = () => o7.useContext(r).localization;
...
@progress/kendo-react-intl/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-IAA7GBY4.js.map
