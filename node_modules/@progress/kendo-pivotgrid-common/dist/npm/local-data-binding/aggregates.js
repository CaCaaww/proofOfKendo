 ...
 */
exports.createAggregate = function (type) {
    var key = AggregateType[type] + "_" + count++;
    switch (type) {
        ...
        case AggregateType.Average:
            var sumProp_1 = key + "_sum";
            var countProp_1 = key + "_count";
            return {
                init: function (data) {
