...
import { memoizeOne as H, getNestedValue as x, validatePackage as X, noop as A, canUseDOM as Y, getter as Z, classNames as ee, WatermarkOverlay as te } from "@progress/kendo-react-common";
import { readColumns as oe, mapColumns as se, tableKeyboardNavigation as R, getSelectionOptions as K, CommonDragLogic as ne, ColumnResize as ae, TableKeyboardNavigationContext as O, tableKeyboardNavigationTools as P, Header as ie, HeaderRow as le, tableColumnsVirtualization as re, tableKeyboardNavigationScopeAttributes as he, TableSelection as de, tableKeyboardNavigationBodyAttributes as ce, DropClue as pe, DragClue as ge, flatData as me, FilterRow as ue } from "@progress/kendo-react-data-tools";
import { setHeaderRowsTop as fe, tableRowsVirtualization as Ce } from "./utils/index.mjs";
import { TreeListCell as ve } from "./cells/TreeListCell.mjs";
import { TreeListNoRecords as be } from "./TreeListNoRecords.mjs";
import { TreeListRow as Se } from "./rows/TreeListRow.mjs";
...
const k = class k extends r.Component {
  constructor(h) {
    super(h), this.element = null, this.wrapperScrollLeft = 0, this.wrapperScrollTop = 0, this.updateOnScroll = !1, this.tbodyOffsetTop = 0, this.prevData = [], this.flattedData = [], this.extendedColumn = [], this.columnsMap = [], this.contextStateRef = { current: void 0 }, this.navigationStateRef = { current: void 0 }, this.showLicenseWatermark = !1, this.scrollIntoView = (e) => {
    ...
    }, this.getExtendedColumn = H((e, t) => oe(e, {
      prevId: 0,
      idPrefix: t
    })), this.getColumnsMap = H((e, t) => se(e, t)), this.onKeyDown = (e) => {
      if (R.onKeyDown(e, {
        navigatable: !1,
      ...
      this.tbodyOffsetTop = o.tBodies[0].offsetTop, fe(o, l);
    }, this.itemChange = (e) => {
    ...
    }, this.getLeafDataItems = () => this.flatData.map((e) => e.dataItem), this.expanded = (e) => !!x(this.props.expandField, e), this.hasChildren = (e) => !!x(this.props.subItemsField, e), this.showLicenseWatermark = !X(Re, { component: "TreeList" }), this.dragLogic = new ne(this.columnReorder, A, A), this.columnResize = new ae(this.onResize.bind(this)), R.onConstructor({
  ...
  render() {
    const {
      ...
      skip: l,
      take: i
    } = this.props, c = h.some((a) => !!a.filter || !!a.filterCell) || e !== void 0, g = e || ue, u = P.getIdPrefix(this.navigationStateRef), F = this.getExtendedColumn(h, u), M = F.length !== this.extendedColumn.length;
    this.extendedColumn = F, this.columnsMap = this.getColumnsMap(this.extendedColumn, M);
    ...
    const y = /* @__PURE__ */ r.createElement(
    ...
    ), L = this.props.style || {}, { colSpans: V, hiddenColumns: U } = re({
      enabled: this.props.columnVirtualization,
      columns: f,
      scrollLeft: this.wrapperScrollLeft,
      tableViewPortWidth: parseFloat((L.width || "").toString())
    }), W = (a, m, D, I, E, w) => f.map((d, p) => {
      if (U[p])
        return null;
      const b = d.id ? d.id : p, z = `${d.className ? d.className + " " : ""}${d.locked ? "k-grid-content-sticky" : ""}`, S = {
      ...
      return m && d.editCell ? /* @__PURE__ */ r.createElement(d.editCell, { key: b, ...S, onChange: this.itemChange }) : d.cell ? /* @__PURE__ */ r.createElement(d.cell, { key: b, ...S }) : /* @__PURE__ */ r.createElement(ve, { key: b, ...S });
    });
    let C = this.flatData;
    const T = C.length;
    l !== void 0 && i !== void 0 && (C = C.slice(l, l + i)), t === "virtual" && (C = Ce({
      rows: C,
      tableViewPortHeight: parseFloat((L.height || L.maxHeight || "").toString()),
      scrollTop: this.wrapperScrollTop
    }), this.updateOnScroll = !1);
    const $ = C.map((a) => a.level), j = this.columnsMap.length + (c ? 1 : 0) + 1, G = C.length > 0 && C.map((a, m) => {
      ...
      }, b = this.props.editRow, z = this.props.row || Se, S = W(a, D, E, w, m, d);
      return D && b ? /* @__PURE__ */ r.createElement(b, { ...p, key: p.key }, S) : /* @__PURE__ */ r.createElement(z, { ...p, key: p.key }, S);
    }) || /* @__PURE__ */ r.createElement("tr", { className: "k-table-row k-grid-norecords" }, /* @__PURE__ */ r.createElement("td", { colSpan: f.length }, this.props.noRecords || /* @__PURE__ */ r.createElement(be, null))), _ = (a) => this.props.sort && this.props.sort.some((m) => m.field === a), q = /* @__PURE__ */ r.createElement(
      "colgroup",
      {
        ref: (a) => {
    ...
    return /* @__PURE__ */ r.createElement(O.Provider, { value: this.contextStateRef.current }, /* @__PURE__ */ r.createElement(
      ...
      this.props.toolbar,
      /* @__PURE__ */ r.createElement(de, { selectable: this.props.selectable, onRelease: this.selectionRelease }, /* @__PURE__ */ r.createElement(
        "table",
        {
      ...
      s && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(pe, { ref: this.dragLogic.refDropElementClue }), /* @__PURE__ */ r.createElement(ge, { ref: this.dragLogic.refDragElementClue })),
      this.showLicenseWatermark && /* @__PURE__ */ r.createElement(te, null)
    ));
  }
  get columns() {
  ...
  get flatData() {
    ...
    const o = (l) => {
      ...
      return t += i.height, i;
    }, s = this.updateOnScroll && this.prevData === h && this.tbodyOffsetTop > 0 && this.flattedData.length ? this.flattedData : me(h, this.expandedSubItems, o);
